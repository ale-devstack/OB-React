      ...
      <div className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <div className="aspect-square bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl flex items-center justify-center text-center p-8">
              <div className="text-white">
                <Hexagon className="w-20 h-20 text-orange-500 fill-orange-500/20 mx-auto mb-6" />
                <div className="text-5xl font-bold mb-2">OrangeBee</div>
